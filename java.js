...
function img_copyright(){
	...
	texto_decriptivo.innerHTML += "<br>2.- Los eventos serán explicados en alguna red social donde se explicara el proceso, meta o alguna otra dinámica, para saber si hay algún evento actualmente puedes ir a la sección de <a onclick=\"eventsForWeb()\">Novedades</a> para saber información previa del evento. En caso de que no haiga eventos podrás verlo ahí mismo.";
}
...
var redNum1 = new redes("./img/redes/instagram.png","Instagram","Actividad: Muy baja","https://www.instagram.com/ghlp2258/","Ir a mi Instagram",false);

var redNum2 = new redes("./img/redes/facebook.png","Facebook","Actividad: Ninguna actualmente","https://www.facebook.com/Ghlp123-114885247082596/","Ir a mi Facebook",false);
...
var redNum4 = new redes("./img/redes/tiktok.png","TikTok","Actividad: De ves en cuando","https://www.tiktok.com/@ghlp2258","Ir a mi TikTok",false);
