...
function img_copyright(){
	...
	texto_decriptivo.innerHTML += `<br><br>4.- <span>JUEGOS GHLP123</span> los juegos aquí activos no recopilan ni envian datos por lo cual se puede jugar con toda tranquilidad.`;
	texto_decriptivo.innerHTML += `<br><br>4.- [Sub 1]--> La <span>Música</span> de los juegos no estan autorizados para tal uso, sin embargo, si algun autor me contacta y se disgusta por ello, la eliminare lo antes posible. (Practicamente me arriesgo a usar algo que no me han autorizado).`;
	texto_decriptivo.innerHTML += `<br><br>4.- [Sub 2]--> Algunos juegos no sirven en <span>android</span> por lo cual una disculpa por ello. Los diseñe mas que nada para <span>PC</span>.`;
}
...
var redNum1 = new redes("./img/redes/instagram.png","Instagram","Actividad: Nada","https://www.instagram.com/ghlp2258/","Ir a mi Instagram",false);

var redNum2 = new redes("./img/redes/facebook.png","Facebook","Actividad: Poca","https://www.facebook.com/Ghlp123-114885247082596/","Ir a mi Facebook",false);

var redNum3 = new redes("./img/redes/twitter.png","Twitter","Actividad: Muy Poca","https://twitter.com/Guiller68818386","Ir a mi Twitter",false);

var redNum4 = new redes("./img/redes/tiktok.png","TikTok","Actividad: Poca","https://www.tiktok.com/@ghlp2258","Ir a mi TikTok",false);

var redNum5 = new redes("./img/redes/hoyolab.png","Hoyolab","Actividad: Nada","https://www.hoyolab.com/accountCenter/postList?id=34855496","Ir a mi Perfil de Hoyolab",false);
...
arrayDesarrollador.push(desarrolloNum1,desarrolloNum2,desarrolloNum3);
